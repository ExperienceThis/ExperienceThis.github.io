(function (t) {
		...
		var r = n("2b0e"),
			...
			s = [function () {
				...
				return n("div", {
					...
					attrs: {
						href: "mailto:experiencethisapp@gmail.com?subject=Experience This Alpha Tester"
					}
				}, [t._v("Alpha Test")])])])])
			}],
			l = {
			...
			h = [function () {
				...
				}, [n("p", [t._v("Coming soon to the App Store!")])])
			}],
			v = (n("a4d3"), n("e01a"), {
				name: "Content",
				data: function () {
					return {
						descriptions: ["Browse the newest and hottest experiences near you,<br/> all in one app at the grasp of your hands.", "Coming to soon to your city!"],
						index: 0,
						description: ""
					}
				},
			...
			O = {
				...
				watch: {
					$route: function (t) {
						document.title = "Get Experience This | Your Experiences in One App";
	...
	e0a9: function (t, e, n) {
		...
		t.exports = n.p + "img/iphone-se2-preview-welcome-2.png"
	},
	f431: function (t, e, n) {}
});
